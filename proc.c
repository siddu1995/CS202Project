...
exit(void)
{
 ...
 int havesiblings = 0;
   for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
     if(p->group_id == curproc->group_id)
        havesiblings++;
  }
